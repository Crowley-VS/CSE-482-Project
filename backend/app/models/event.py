...
class Event(Base):
    ...
    event_type = Column(String(100), nullable=True, index=True)  # e.g., 'inflation', 'fed_announcement'
...
class EventSummary(Base):
    ...
    summary_method = Column(String(50), nullable=False)  # 'extractive', 'bart', 't5', etc.
